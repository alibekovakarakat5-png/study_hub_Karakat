...
// Creates / updates:
//   Teacher : Карақат  aksharayev@gmail.com  role=teacher
...
const TEACHER_EMAIL  = 'aksharayev@gmail.com'
const TEACHER_NAME   = 'Карақат Акшаева'
...
async function main() {
  console.log('\n══════════════════════════════════════════')
  console.log('  StudyHub seed: Карақат + Никита + класс')
  console.log('══════════════════════════════════════════\n')
